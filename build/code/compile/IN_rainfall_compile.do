...
INPUTS: 		${builddta}/round2/IN_rainfall_r2_compiled_prep.dta
				${builddta}/round3/IN_rainfall_r3_prep.dta
				${builddta}/intervention/IN_rainfall_intervention.dta
				${builddta}/followup_2014/Analysis_variables.dta
				${builddta}/admin/Insur_payout_Kharif2014_cleaned.dta
...
// Round 2
use "${builddta}/round2/IN_rainfall_r2_compiled_prep.dta"
isid a_1hhid
save `round2dta'

// Round 3
use "${builddta}/round3/IN_rainfall_r3_prep.dta", clear
isid a_1hhid
save `round3dta'
...
drop r2_distid-r2_villname _merge
...
foreach round in r2 r3 {
	gen `round'_insur_payout=.
	replace `round'_insur_payout=0 if (`round'_insur_agreed==1 & _adminmerge==1) // purchased but did NOT get payout
	replace `round'_insur_payout=1 if (`round'_insur_agreed==1 & _adminmerge==3) // purchased and did get payout
	replace `round'_insur_unitpurchased=total_insurance_unit if (`round'_insur_payout==1) // update unit purchased using admin data
	gen `round'_insur_claim_amt = claims if (`round'_insur_payout==1) // Amount of insurance claim received in round 2/3
	order `round'_insur_payout `round'_insur_claim_amt, after(`round'_insur_unitpurchased)
	
	lab var `round'_insur_payout "Whether HH received insurance payout in `round'"
	lab var `round'_insur_claim_amt "Amount of insurance claim received in `round'"
}
*
...
replace r2_insur_agreed=1 if (a_1hhid=="A455")
replace r2_insur_unitpurchased=2 if (a_1hhid=="A455")
replace r2_insur_payout=1 if (a_1hhid=="A455")
replace r2_insur_claim_amt=1500 if (a_1hhid=="A455")
replace r3_insur_agreed=1 if (a_1hhid=="A455")
replace r3_insur_unitpurchased=1 if (a_1hhid=="A455")
replace r3_insur_payout=1 if (a_1hhid=="A455")
replace r3_insur_claim_amt=750 if (a_1hhid=="A455")

// "A530" purchased 2 units in round 2, and 1 unit in round 3
replace r2_insur_agreed=1 if (a_1hhid=="A530")
replace r2_insur_unitpurchased=2 if (a_1hhid=="A530")
replace r2_insur_payout=1 if (a_1hhid=="A530")
replace r2_insur_claim_amt=2400 if (a_1hhid=="A530")
replace r3_insur_agreed=1 if (a_1hhid=="A530")
replace r3_insur_unitpurchased=1 if (a_1hhid=="A530")
replace r3_insur_payout=1 if (a_1hhid=="A530")
replace r3_insur_claim_amt=1200 if (a_1hhid=="A530")

// "P1551" purchased 2 units in round 2, and 1 unit in round 3
replace r2_insur_agreed=1 if (a_1hhid=="P1551")
replace r2_insur_unitpurchased=2 if (a_1hhid=="P1551")
replace r2_insur_payout=1 if (a_1hhid=="P1551")
replace r2_insur_claim_amt=2400 if (a_1hhid=="P1551")
replace r3_insur_agreed=1 if (a_1hhid=="P1551")
replace r3_insur_unitpurchased=1 if (a_1hhid=="P1551")
replace r3_insur_payout=1 if (a_1hhid=="P1551")
replace r3_insur_claim_amt=1200 if (a_1hhid=="P1551")
