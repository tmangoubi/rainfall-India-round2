...
TITLE:			SectionH7_IrregularCrops_Output_clean.do
...
DESCRIPTION: 	Import & clean Section H7 of 2014 follow-up survey data
...
INPUTS: 		// Raw data 
					// Section H7
						${followup_data}/AP Raw/SectionH4Output_1.dta
						${followup_data}/TN Raw/SectionH4Output_1.dta 
						${followup_data}/UP Raw/SectionH4Output_1.dta" 
											
OUTPUTS: 		${builddta}/followup_2014/SectionH7_IrregularCrops_Output_cleaned.dta
				
NOTE:			This do-file is based on
				- "${follow_data}/Do Files/SectionH4Output_1.do"
...
loc name_do SectionH7_IrregularCrops_Output_clean
...
// Section H7
use "${followup_data}/AP Raw/SectionH4Output_1.dta", clear
append using "${followup_data}/TN Raw/SectionH4Output_1.dta" 
append using "${followup_data}/UP Raw/SectionH4Output_1.dta" 
isid Id subid
...
label value q711_cropcode cropcode1
label var q712_croppat "Cropping Pattern"
label var q713_cropmixplant "Which crop did you mix planting?"
label var q714_area "Unit"
label var q714_area_oth "Unit Other"
label var q715_outputqty "Output Quantity"
label var q715_cropunit "Unit"
label var q715_cropunit_oth "Unit Other"
label var q715_cropkgunit "Kg / unit"
label var q715_2_amount "Amount"
label var q716_totval "Value of Output"
label var q717_outcomp "Output Compared to last 3 years"
label define mix 1 "Mixed" 2 "Separate"
label define unit 1 "Acre" 2 "Bhigha" 3 "Cents" 4 "Guntha" 5 "Biswa" 6 "Bhigha" 7 "Kuli" 8 "MA" -888 "Other"
label value  q714_area q715_cropunit unit
label value  q712_croppat mix
...
qui compress
save "${builddta}/followup_2014/SectionH7_IrregularCrops_Output_cleaned.dta", replace
