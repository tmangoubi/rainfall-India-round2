...
TITLE:			SectionE2_KharifCrop_Material_clean.do
...
INPUTS: 		// Raw data 
					${followup_data}/AP Raw/SectionECostRoster_1.dta
					${followup_data}/TN Raw/SectionECostRoster_1.dta
					${followup_data}/UP Raw/SectionECostRoster_1.dta
						
OUTPUTS: 		${builddta}/followup_2014/SectionE2_KharifCrop_Cost_cleaned.dta
				
NOTE:			This do-file is based on
				- "${follow_data}/Do Files/SectionECostRoster_1.do"
...
use "${followup_data}/AP Raw/SectionECostRoster_1.dta", clear
append using "${followup_data}/TN Raw/SectionECostRoster_1.dta" 
append using "${followup_data}/UP Raw/SectionECostRoster_1.dta" 
isid Id subid
...
label var q4152_cropcode "Crop code"
...
label value q4152_cropcode cropcode
label var q416_1_bulowndayuse "Bullock - Own (days)"
label var q416_2_bulowndayuse "Bullock - Own (days)" //check variable - repeated twice?
label var q417_bulhireunit "Bullock - Hired (Units)"
label var q418_bulhiredays "Bullock - Hired (Days)"
label var q419_traowndays "Tractor - Own (days)" 
label var q420_trahireunit "Tractor - Hired (Units)"
label var q421_trahireval "Tractor - Hired (Value)" // SL: This is origianlly labeled as "days", but it seems it is actually "value"
label var q422_ownirrdayuse "Irrigation - Own (Days)"
label var q423_ownirrexpe "Irrigation - Own (Expenditure)"
label var q424_irrpurdayuse "Irrigation - Purchased (Days)"
label var q425_irrpurval "Irrigation - Purchased (Value)"
label var q426_irrpurrelat "Irrigation - Purchased (relation)"
label var q426_irrpurrelatoth "Irrigation - Purchased (relation - Other)"
label var q427_trancost "Transport Costs"
label var q428_othmatinputcost "Other material inputs costs"
...
label value q426_irrpurrelat relation
...
loc E2vars_num `r(varlist)'
ds q4152_cropcode-q428_othmatinputcost, has(type string)
loc E2vars_str `r(varlist)'
...
qui compress
save "${builddta}/followup_2014/SectionE2_KharifCrop_Cost_cleaned.dta", replace
