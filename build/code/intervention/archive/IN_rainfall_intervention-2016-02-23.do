...
INPUTS: 		${IN_rainfall_r2r3}/Sample/Randomization/pii_data/round 3/insur_final.dta
				${IN_rainfall_r2r3}/Sample/Randomization/select_insurance_and_mig.dta
...
clear
use "${IN_rainfall_r2r3}/Sample/Randomization/select_insurance_and_mig.dta"
drop _merge
sort hhid
...
label define round22 0 "Nothing" 1 "Ticket-Mig" 2 "Cash-Mig" 3 "Insurance"
label define round33 0 "Nothing" 1 "Insurance" 2 "Insurance+IMD"
...
// "${IN_rainfall_r2r3}/Sample/Randomization/select_insurance_and_mig.dta" has more complete information, so we will use id variable from this data
drop redsid-blockname

// Label ID variable
label var dressid "REDS ID"
label var reds_vill "REDS ID_VILL ID"
